    ...
    <section className="hero">
      <div className="container hero-container">
        <div className="hero-content">
          <div className="badge">🚀 Fibra Óptica Real</div>
          <h1 className="hero-title">
            Navega sin límites con <span className="text-gradient">Idatel</span>
          </h1>
          <p className="hero-subtitle">
            El internet de fibra óptica que tu hogar y empresa merecen. Velocidad simétrica, instalación en 24h y soporte local experto.
          </p>
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-contact">
            <h4>Contáctanos</h4>
            <a href={`tel:+${WHATSAPP_NUMBER}`} className="contact-link"><PhoneCall size={18} /> +57 (300) 000-0000</a>
